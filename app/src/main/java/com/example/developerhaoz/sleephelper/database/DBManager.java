package com.example.developerhaoz.sleephelper.database;
...
import static com.example.developerhaoz.sleephelper.database.DatabaseHelper.ID_COLUMN;
import static com.example.developerhaoz.sleephelper.database.DatabaseHelper.MUSIC_ID_COLUMN;
...
//			values.put("mylove",0);
    ...
    public void removeMusic(int id, int witchActivity) {
        ...
        switch (witchActivity) {
            case AppConstants.ACTIVITY_LOCAL:
                db.delete(DatabaseHelper.MUSIC_TABLE, ID_COLUMN + " = ? ", new String[]{"" + id});
                break;
            case AppConstants.ACTIVITY_RECENTPLAY:
                db.delete(DatabaseHelper.LAST_PLAY_TABLE, ID_COLUMN + " = ? ", new String[]{"" + id});
                break;
            case AppConstants.ACTIVITY_MYLOVE:
                ContentValues values = new ContentValues();
