...
import com.example.developerhaoz.sleephelper.recyclerview.adapter.PlaylistAdapter;
...
public class PlaylistActivity extends PlayBarBaseActivity {
    ...
    private void initView(){
        ...
        playlistAdapter.setOnItemClickListener(new PlaylistAdapter.OnItemClickListener() {
            ...
            public void onDeleteMenuClick(View swipeView, int position) {
                ...
                final int musicId = SpUtils.getIntShared(AppConstants.KEY_ID);
    ...
    public void showPopFormBottom(MusicInfo musicInfo) {
        MusicPopMenuWindow menuPopupWindow = new MusicPopMenuWindow(PlaylistActivity.this,musicInfo,findViewById(R.id.activity_playlist),AppConstants.ACTIVITY_MYLIST);
